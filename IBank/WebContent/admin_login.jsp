...
<div class="container-fluid">
	...
	<div class="row" style="margin-top:100px;">
		<div class="col-sm-12 col-xs-12 text-center"><span class="logoText h1">IBANK ADMIN</span></div>
	</div>
	...
	<div id="loginBox" class="box col-xs-12 col-sm-5 col-md-5 col-lg-4 col-centered" align="left">
		<form method="post" class="login_form form-horizontal col-md-12 col-lg-12" action="" style="padding-left:15px; padding-right:15px; padding-top:25px; padding-bottom: 0px;">
			...
			<div class="form-group">
				<label for="adminNameTxt" class="col-lg-3 col-md-3 control-label">User Id</label>
				<div class="col-lg-9 col-md-9"><input type="text" class=" form-control" placeholder="Enter your Username" name="adminIdTxt" /></div>
			</div>
			
			<div class="form-group">
				<label for="adminpassTxt" class="col-lg-3 col-md-3 control-label">Password</label>
				<div class="col-lg-9 col-md-9"><input class="form-control" placeholder="Enter your Password" type="password" name="adminPasswordTxt" /></div>
			</div>
