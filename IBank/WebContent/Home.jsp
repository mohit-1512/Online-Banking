...
<div class="row row-centered">
	<div id="loginBox" class="box col-xs-12 col-sm-5 col-md-5 col-lg-4 col-centered" align="left">
		<form class="login_form form-horizontal col-md-12 col-lg-12" action="" style="padding-left:15px; padding-right:15px; padding-top:25px; padding-bottom: 0px;">
			
			
			
			<div class="col-md-12 col-lg-12 alert alert-danger text-center hidden">
			Invalid Username or Password!
			</div>
			
			<div class="form-group">
				<label for="usernameTxt" class="col-lg-3 col-md-3 control-label">Username</label>
				<div class="col-lg-9 col-md-9"><input type="text" class=" form-control" placeholder="Enter your Username" name="usernameTxt" /></div>
			</div>
